...
function ExerciseDisplay({
  ...
  function handleSetChange(set: (exerciseSet & {priorSet: exerciseSet | null}), index: number) {
    const newSets = [...sets];
    newSets[index] = set;
    setSets(newSets);
  }
  function handleSaveButton() {
    const newData: ActualExercise & { sets: (exerciseSet & {priorSet: exerciseSet | null})[] } = {
      ...exercise,
      sets: sets,
