...
//  getExerciseByWorkoutId: publicProcedure.input(z.object({
  ...
  deleteExercise: privateProcedure.input(
    z.object({
      exerciseId: z.string(),
    })
  ).mutation(async ({ctx, input}) =>{
  ...
  updateExerciseDescription: privateProcedure.input(
    z.object({
      exerciseId: z.string(),
      description: z.string(),
    })
  ...
  createSet: privateProcedure.input(
    z.object({
      setId: z.string(),
      exerciseId: z.string(),
      weight: z.number(),
  ...
  removeSet: privateProcedure.input(
    z.object({
      setId: z.string(),
    })
  ).mutation(async ({ctx, input}) => {
  ...
  updateSets: privateProcedure.input(
    z.object({
      setId: z.string(),
      weight: z.number(),
      reps: z.number(),
